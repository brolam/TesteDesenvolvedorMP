...
class EvaluationViewTest(TestCase):
    ...
    def test_submit_is_frontEnd_backEnd_and_mobile_developer(self):
        ...
        self.assertEqual(evaluation.is_developer_generic(), False, 'Must not be One Developer Generic.')
    ...
    def test_submit_is_one_generic_developer(self):
        ...
        self.assertEqual(evaluation.is_developer_generic(), True, 'Must be One Developer Generic.')
