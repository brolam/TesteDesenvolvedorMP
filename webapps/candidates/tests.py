...
class CandidateEvaluationModelTest(TestCase):
    ...
    def test_is_or_not_development_front_end(self):
        for rating in range(7, 11):
            ...
            self.assertEqual(self.evaluation.is_development_front_end(), True, msg_rating)
            self.evaluation.skill_tec_javascript_rating = 6
            self.assertEqual(self.evaluation.is_development_front_end(), False, msg_rating)
            self.evaluation.skill_tec_javascript_rating = rating
            self.assertEqual(self.evaluation.is_development_front_end(), True, msg_rating)
    ...
    def test_is_or_not_development_back_end(self):
        for rating in range(7, 11):
            msg_rating = ' On rating: %s.' %(rating)
            self.evaluation.skill_tec_python_rating = rating
            self.evaluation.skill_tec_django_rating  = rating
            self.assertEqual(self.evaluation.is_development_back_end(), True)
            self.evaluation.skill_tec_django_rating  = 6
            self.assertEqual(self.evaluation.is_development_back_end(), False)
            self.evaluation.skill_tec_django_rating  = rating
            self.assertEqual(self.evaluation.is_development_back_end(), True)
    ...
    def test_is_or_not_development_mobile(self):
        for rating in range(7, 11):
            msg_rating = ' On rating: %s.' %(rating)
            self.evaluation.skill_tec_ios_rating = rating
            self.evaluation.skill_tec_android_rating  = rating
            self.assertEqual(self.evaluation.is_development_mobile(), True, msg_rating)
            self.evaluation.skill_tec_android_rating  = 6
            self.assertEqual(self.evaluation.is_development_mobile(), False, msg_rating)
            self.evaluation.skill_tec_android_rating = rating
            self.assertEqual(self.evaluation.is_development_mobile(), True, msg_rating)
    ...
    def test_is_or_not_development_generic(self):
        for rating in range(7, 11):
            msg_rating = ' On rating: %s.' %(rating)
            self.evaluation.skill_tec_html_rating = 6 
            self.evaluation.skill_tec_css_rating  = 6
            ...
            self.evaluation.skill_tec_ios_rating = 6 
            self.evaluation.skill_tec_android_rating  = 6
            self.assertEqual(self.evaluation.is_development_generic(), True, msg_rating)
            self.evaluation.skill_tec_html_rating = rating 
            self.evaluation.skill_tec_css_rating  = rating
            self.evaluation.skill_tec_javascript_rating = rating
            self.evaluation.skill_tec_python_rating = rating
            ...
            self.evaluation.skill_tec_ios_rating = rating
            self.evaluation.skill_tec_android_rating  = rating
            self.assertEqual(self.evaluation.is_development_generic(), False, msg_rating)
